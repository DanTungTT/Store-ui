...
const ProductFlashSale = ({ name, images, voucher, events, shopTag, price, sales, quantity = 1 }) => {
    ...
    return (
        <>
            <div className="w-[22.5rem] h-[37.6rem]  mx-2 cursor-pointer hover:shadow-[0_0_.5rem_#333] hover:-translate-y-2 py-3 transition-all duration-200 ">
                <div className="h-[22.5rem]  flex justify-center items-center overflow-hidden rounded-[.6rem] relative">
                    ...
                    <div>
                        ...
                        <div
                            className={`relative bg-[#febca5]  text-[1.2rem] px-3  rounded-2xl mb-1 text-secondaryColor 
                                         after:content-[''] after:absolute after:left-0 after:w-[${w}%] after:h-full after:bg-[linear-gradient(to_right,_#ff6633,_#f63f2e)] after:rounded-2xl 
