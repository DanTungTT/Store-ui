                ...
                {!isAuthen ? (
                    ...
                    <div className="h-[90%]">
                        ...
                        <div className="flex border border-[#e6e3e3]">
                            <Button title="Đăng ký" typeStyle="primary" className={btnStyles} to="/register" />
                            <Button title="Đăng nhập" typeStyle="primary" className={btnStyles} to="/login" />
                        </div>
                    </div>
                ) : (
                    // user loggined
                    <div className="flex flex-col h-full">
                        <div className="p-1 border-b border-[#c0bebe] flex-0">
                            <div className="headding bg-[var(--primary-color-)] p-2">
                                <h5 className="text-[1.5rem]">Thông báo </h5>
                            </div>
                            <div className="flex justify-between [&>span]:text-white [&>span]:bg-[var(--primary-color-)] w-full [&>span]:m-1 [&>span]:p-2 [&>span]:text-center">
                                <span className="flex-1">Tất cả</span>
                                <span className="flex-1">Chưa xem</span>
                                <span className="flex-1">Đã xem</span>
                            </div>
                        </div>
                        {/*  list noti  */}
                        <div className="flex-1 flex justify-center items-center">
                            <h3 className="text-[var(--primary-textColor-)]">Bạn chưa co thông báo</h3>
                        </div>
                        {/* footer noti */}
                        <div className="footer flex-0 [&>span]:bg-[var(--primary-color-)] [&>span]:p-3 flex p-1">
                            <span className="flex-1 text-center">Xem thêm</span>
                            <span className="flex-1 text-center">Đánh dấu đã đọc</span>
                        </div>
                    </div>
                )}
            </FloatingBox>
